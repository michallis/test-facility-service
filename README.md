# Enelyzer: facility-service

[![][Enelyzer-logo]][Enprove-url]
...
```shell
> curl -XPOST -H "Content-Type: application/json" localhost:9000/com.enelyzer.CounterService/GetCurrentCounter -d '{"counterId": "foo"}'
...
```shell
> grpcurl -plaintext -d '{"counterId": "foo"}' localhost:9000 com.enelyzer.CounterService/GetCurrentCounter 
ERROR:
  Code: Unknown
...
[Enelyzer-logo]: https://i.imgur.com/rItAfHs.png